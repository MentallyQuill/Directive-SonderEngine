...
| Notices and bounded creator assist | In progress | Persistent gameplay notice production/lifecycle and optional bounded creator assist remain; Settings correctly preserves Sonder ownership of provider/model configuration |
