...
|---|---|---|
| Repository, test harness and extension package | In progress | Manifest discovery, enable/disable isolation, clean test entrypoint |
...
| Atomic Ashes provisioning | Assessed | Target integration proves success and rollback-on-failure |
| Directive state schemas/domain services | Assessed | Unit tests for strict inputs and deterministic reducers |
...
| SillyTavern removal audit | Assessed | Runtime import/network forbidden-dependency gate |
